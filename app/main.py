...
# ── Page Routing ──────────────────────────────────────────────────────────────
if   "Home"         in page: exec(open("app/pages/home.py", encoding="utf-8").read())
elif "Inventory"    in page: exec(open("app/pages/inventory.py", encoding="utf-8").read())
elif "Sustainability" in page: exec(open("app/pages/sustainability.py", encoding="utf-8").read())
elif "Scenario"     in page: exec(open("app/pages/scenario.py", encoding="utf-8").read())
elif "CFO"          in page: exec(open("app/pages/cfo.py", encoding="utf-8").read())
